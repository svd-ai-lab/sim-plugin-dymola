...
def test_wheel_contains_skills(tmp_path: Path) -> None:
    ...
    wheels = list(out_dir.glob("sim_plugin_dymola-*.whl"))
    ...
    required = {
        "sim_plugin_dymola/__init__.py",
        "sim_plugin_dymola/driver.py",
        "sim_plugin_dymola/compatibility.yaml",
        "sim_plugin_dymola/_skills/dymola/SKILL.md",
    }
